...
namespace EstoqueWeb.Controllers 
{
    public class EnderecoController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? cid)
        {
            ...
            {
                TempData["mensagem"] = MensagemModel.Serializar("Só é possivel mostrar endereços de um cliente específico.", TipoMensagem.Erro);
                return RedirectToAction("Index", "Cliente");
            }
        }
            ...
            if (idUsuario.HasValue)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (endereco.IdEndereco > 0)
                    {
                        ...
                        {
                            var enderecoAtual = cliente.Enderecos.FirstOrDefault(e => e.IdEndereco == endereco.IdEndereco);
